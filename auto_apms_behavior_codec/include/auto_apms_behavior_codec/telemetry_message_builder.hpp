...
// This class provides an interface to build telemetry messages with different types of entries and serialize them for
// transmission and rebuild the messages from serialized data. Currently, message building and serialization is the
// focus, later on methods to interact with received telemetry for example for display purposes are to be added to this,
// or the telemetry message directly.
